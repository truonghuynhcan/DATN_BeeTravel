...
{{-- <div class="text-center ">
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../assets/image/baner1.jpg" class="d-block w-100" height="500" alt="...">
            ...
            <div class="carousel-item">
                <img src="../assets/image/baner2.jpg" class="d-block w-100" height="500" alt="...">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="search-bar" style="margin-top: -66px;">
        <div class="container mt-5">
            <div class="input-group">
                <input type="text" class="form-control rounded" placeholder="Tìm kiếm" aria-label="Search">
...
<div class="container">
    ...
    <div class="row banner-img">
        <div class="col-md-6">
            <img src="../assets/image/baner1.jpg" alt="" style="height: 400px; width: 100%;">
        </div>
        <div class="col-md-6">
            <img src="../assets/image/baner2.jpg" alt="" style="height: 195px; width: 100%;">
            <img src="../assets/image/baner2.jpg" alt="" style="height: 195px; width: 100%; margin-top: 10px;">
        </div>
    </div>
    <!-- product -->
    <div class="product">
    ...
    <div class="yeuthich">
        ...
        <div class="row">
            <div class="col-3">
                <img src="../assets/image/64114914e5a8ec33c25f2e2407db47a5.jpg" alt=""
