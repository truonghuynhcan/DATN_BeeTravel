...
@section('main')
    ...
    <form action="{{ route('admin.providerInsert_') }}" method="post" enctype="multipart/form-data">
        @csrf
        <header class="bg-body p-2 d-flex justify-content-between mb-2 sticky-top z-1">
            <h2 class="">Thêm đối tác mới</h2>
            <div>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <section class="bg-body rounded mb-3">
                    <input name="name" value="{{ old('name') }}" id="name" class="form-control form-control-lg" type="text" placeholder="Tên đối tác (không vượt quá 255 ký tự) " aria-label=".form-control-lg example">
                </section>
